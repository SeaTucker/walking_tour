...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-10371118.396483, 5542063.827437, -10370257.894918, 5543763.745228],
            units: 'm'
        })
    })
});
...
map.getView().fit([-10371663.256407, 5542177.667494, -10370143.898167, 5543181.251771], map.getSize());
