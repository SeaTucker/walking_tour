...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-10371118.396483, 5542064.083923, -10370257.894918, 5543762.861863],
            units: 'm'
        })
    })
});
...
map.getView().fit([-10372236.126891, 5541778.358960, -10368745.806239, 5543944.641819], map.getSize());
